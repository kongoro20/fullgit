...
def perform_actions():
    ...
    # Write a random name (6-8 characters) only
    random_name = generate_random_name(random.randint(6, 8)) + str(random.randint(10, 99))
    human_typing(random_name)

    # Save the full email to a file
    saved_email = random_name + "@outlook.com"
    with open("save_email.txt", "w") as f:
        f.write(saved_email)
    ...
    # Random click in specific area
    random_click_in_area((79, 328), (303, 518))
    time.sleep(random.uniform(1, 1.5))
    ...
    # Random click in specific area
    random_click_in_area((512, 393), (776, 399))
    time.sleep(random.uniform(1, 2))
    ...
    # Random click in specific area
    random_click_in_area((514, 448), (798, 453))
    time.sleep(random.uniform(1, 2))
