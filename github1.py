...
random_click_in_rectangle((809, 249), (1219, 264))
...
random_click_in_rectangle((816, 546), (1217, 567))
time.sleep(random.uniform(3.5, 4.5))
random_click_in_rectangle((1282, 446), (1326, 509))
time.sleep(1)
...
while True:
    ...
    try:
        ...
        if button_location:
            random_click_in_rectangle((818, 548), (1215, 567))
            time.sleep(2)
